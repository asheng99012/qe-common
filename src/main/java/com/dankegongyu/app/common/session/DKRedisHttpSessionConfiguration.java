 ...
 */
public class DKRedisHttpSessionConfiguration extends SpringHttpSessionConfiguration
    ...
    public RedisMessageListenerContainer redisMessageListenerContainer(
            ...
            DKRedisOperationsSessionRepository messageListener) {
    ...
    @Bean
    public DKRedisOperationsSessionRepository sessionRepository(
            @Qualifier("sessionRedisTemplate") RedisOperations<Object, Object> sessionRedisTemplate,
            ApplicationEventPublisher applicationEventPublisher) {
        DKRedisOperationsSessionRepository sessionRepository = new DKRedisOperationsSessionRepository(
