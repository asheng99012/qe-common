...
public class SHA1 {  
    public static String generate(byte[] dataBytes) throws Exception {  
...
//      return num << lmov | num >> (32 - lmov);  
  ...
  public static void main(String[] args) {
	//String s = "af66 750d 22a9 2c3f d187 1cb3 cbb5 c181 81e9 dd27";
	String s = "INTERNAL SERV1CE sa1t";
	Long timestamp = System.currentTimeMillis()/1000;
	String key = s + timestamp;
	
	System.out.println(key);  
    try {
		System.out.println("sha1: " + SHA1.generate(key.getBytes()));
	} catch (Exception e) {
