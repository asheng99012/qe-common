...
public class ExcelRead {      
     ...
     * @throws IOException  
     */  
    public List<ArrayList<String>> readExcel(FileItem file) throws IOException {  
        if(file==null||ExcelUtil.EMPTY.equals(file.getName().trim())){  
            ...
            if(!ExcelUtil.EMPTY.equals(postfix)){  
                if(ExcelUtil.OFFICE_EXCEL_2003_POSTFIX.equals(postfix)){  
                    return readXlsIn(file.getInputStream());  
                }else if(ExcelUtil.OFFICE_EXCEL_2010_POSTFIX.equals(postfix)){  
                    return readXlsxIn(file.getInputStream());  
                }else{                    
                    return null;  
                }  
            }  
    ...
    public List<ArrayList<String>> readXlsIn(InputStream input){   
        List<ArrayList<String>> list = new ArrayList<ArrayList<String>>();  
        // IO流读取文件  
       // InputStream input = null;  
        HSSFWorkbook wb = null;  
    ...
    @SuppressWarnings("deprecation")  
    public List<ArrayList<String>> readXlsxIn(InputStream input){  
        List<ArrayList<String>> list = new ArrayList<ArrayList<String>>();  
        XSSFWorkbook wb = null;  
        ArrayList<String> rowList = null;  
        try {  
